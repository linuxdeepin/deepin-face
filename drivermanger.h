...
public:
    DriverManger();
    void init();
    QDBusUnixFileDescriptor enrollStart(QString chara, qint32 charaType, QString actionId, ErrMsgInfo& errMsgInfo);
    void enrollStop(QString actionId, ErrMsgInfo& errMsgInfo);
    QDBusUnixFileDescriptor verifyStart(QStringList charas, QString actionId, ErrMsgInfo& errMsgInfo);
