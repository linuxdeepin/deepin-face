...
QDBusUnixFileDescriptor DbusFaceService::EnrollStart(QString chara, qint32 charaType, QString actionId){

    qDebug()<<"EnrollStart chara"<<chara<<" charaType"<<charaType<<" actionId"<<actionId;
